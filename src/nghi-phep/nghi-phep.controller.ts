...
import { CreateNghiPhepDto } from './dto/create-nghi-phep.dto';
...
export class NghiPhepController {
  ...
  @Post(':maNV')
  create(
    @Param('maNV', ParseIntPipe) maNV: number,
    @Body() body: CreateNghiPhepDto,
  ) {
  ...
  @Put('duyet/:maDon')
  duyet(
    @Param('maDon', ParseIntPipe) maDon: number,
  ...
  @Roles('nhansu', 'quantrivien')
  @Delete(':maDon')
  remove(@Param('maDon', ParseIntPipe) maDon: number) {
